            ...
            >
              ...
              >
                <div class="grid grid-cols-3 gap-5 normal-case tracking-normal">
                  <div>
                    <h4 class="text-[10px] font-bold text-gray-400 tracking-wider mb-4 uppercase">
                      Produk
                    </h4>
                    <div class="flex flex-col gap-3">
                      <a
                        href="#"
                        class="flex gap-3 items-start p-2 -mx-2 rounded-xl hover:bg-gray-50 group transition-colors"
                      >
                        <div class="text-[#cc2b35] mt-0.5" v-html="megaIcons.OnCall"></div>
                        <div>
                          <div
                            class="text-[13px] font-[650] text-[#111827] group-hover:text-[#cc2b35] transition-colors"
                          >
                            Undangan Digital
                          </div>
                          <div class="text-[12px] text-gray-500 mt-0.5 mb-1 text-balance">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div class="text-[12px] text-gray-500 mt-0.5 text-balance">
                      ...
                      >
                        <div
                          class="text-[#cc2b35] mt-0.5 flex justify-center"
                  ...
                  <div>
                    ...
                    <div class="flex flex-col gap-1">
                      <a
                        href="#"
                        class="p-2 -mx-2 rounded-xl hover:bg-gray-50 group transition-colors"
                      >
                        <div
                          class="text-[13px] font-[650] text-[#111827] flex items-center gap-2 group-hover:text-[#cc2b35] transition-colors"
                        >
                          AI Generator
                          <span
                            class="bg-[#cc2b35]/10 text-[#cc2b35] text-[9px] font-bold px-1.5 py-0.5 rounded-full tracking-wider"
                            >NEW</span
                          >
                        </div>
                        <div class="text-[12px] text-gray-500 mt-0.5 leading-snug">
                  ...
                  <div class="flex flex-col">
                    ...
                    <div
                      class="flex-1 rounded-2xl bg-[#0f1115] p-4 flex flex-col items-center text-center relative overflow-hidden group/card shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] cursor-pointer"
                    >
                      <div
                        class="text-[9px] tracking-widest text-[#cc2b35] font-bold mb-2 z-10 uppercase"
                      >
                        The Abadikan Way
                      </div>
                      <div
                        class="text-[16px] font-[600] leading-tight text-white mb-4 z-10 max-w-[150px] tracking-tight"
                      >
                        Momen bahagia anda pantas dirayakan secara mewah.
                      </div>
                      <div
                        class="mt-auto px-4 py-1.5 border border-white/20 rounded-lg text-[12px] font-semibold text-white z-10 hover:bg-white hover:text-black transition-colors"
                      >
                        Baca Selengkapnya
                      </div>
                      <div
                        class="absolute -bottom-16 w-[200px] h-[140px] bg-[#cc2b35] rounded-full blur-[40px] opacity-40 group-hover/card:opacity-60 transition-opacity duration-500"
                      ></div>
                      <div
                        class="absolute bottom-6 w-8 h-8 rounded-xl bg-gradient-to-tr from-[#cc2b35] to-[#f44336] z-10 shadow-[0_0_20px_#cc2b35] flex items-center justify-center text-white scale-0 group-hover/card:scale-100 transition-transform duration-300"
                        v-html="megaIcons.Fire"
                      ></div>
                    </div>
                  </div>
      ...
      <template #end>
        <div class="flex items-center gap-[10px] w-[160px] justify-end">
          <Button
            ...
            :style="
              !bgActive
                ? '--btn-bg: transparent; --btn-text: #FFFFFF; --btn-border: rgba(255,255,255,0.65); --btn-hover-bg: rgba(255,255,255,0.12); --btn-hover-border: rgba(255,255,255,0.85); --btn-hover-text: #FFFFFF;'
                : ''
            "
            >Login</Button
          >
          <Button
            ...
            :style="
              !bgActive
                ? '--btn-bg: #111827; --btn-text: #FFFFFF; --btn-border: #111827; --btn-hover-bg: #000000; --btn-hover-border: #000000;'
                : ''
            "
            >Daftar</Button
          >
