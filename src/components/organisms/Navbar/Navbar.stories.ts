...
export const FloatingMegaMenu: Story = {
  ...
  render: (args) => ({
    ...
    setup() {
      ...
      return { args, showMega, hovering, isScrolled, bgActive, icons, onNavEnter, onNavLeave, onMegaEnter, onMegaLeave }
    },
    template: `
      <div
