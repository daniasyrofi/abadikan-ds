...
<template>
  <div class="wa-fab-wrapper">
    <!-- Tooltip -->
    <div class="wa-tooltip" aria-hidden="true">Chat kami, respons &lt; 5 menit</div>

    <!-- Button -->
    <button class="wa-fab" :aria-label="'Chat via WhatsApp'" @click="openWA">
      <svg
        width="28"
        height="28"
        viewBox="0 0 24 24"
...
<style scoped>
/* ── Wrapper — anchors tooltip above the button ───────────────────────────── */
.wa-fab-wrapper {
  position: fixed;
  bottom: 24px;
  right: 24px;
