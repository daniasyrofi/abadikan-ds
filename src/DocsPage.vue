...
<template>
  ...
  >
    ...
    >
      <Navbar :border="false" class="!max-w-none! !rounded-none! !h-14! !px-4!">
        <!-- Logo + title -->
        <template #start>
        ...
        <template #end>
          <div class="flex items-center gap-2">
            <SearchInput v-model="searchQuery" placeholder="Search..." size="sm" class="w-44" />
            <ThemeToggle size="sm" />
    ...
    <div class="flex">
      ...
      <main class="flex-1 min-w-0 px-12 py-8 max-w-3xl">
        ...
        <!-- Description -->
        <p class="text-[15px] leading-relaxed mb-6" style="color: var(--color-text-secondary)">
          Claude is a highly performant, trustworthy, and intelligent AI platform built by
          Anthropic. Claude excels at tasks involving language, reasoning, analysis, coding, and
          more.
        </p>
          ...
          <ul class="space-y-2">
            <li class="text-sm">
              ...
              <span style="color: var(--color-text-secondary)">
                — Our most intelligent model, and the world's best model for coding, enterprise
          ...
          <div class="space-y-6">
            <div v-for="step in steps" :key="step.num" class="flex gap-4">
              ...
              <div class="flex-1 pt-0.5">
                <h3 class="text-[15px] font-semibold mb-1" style="color: var(--color-text-heading)">
                  {{ step.title }}
                </h3>
                <p
                  v-if="step.desc"
                ...
                <Button v-if="step.link" variant="link" size="sm" as="a" href="#">
                  {{ step.link }}
                </Button>
              </div>
            </div>
