      ...
      <div style="${GRID}">
        ...
        <div style="${RIGHT}">
          <div style="${FORM}">
            ...
            <form style="display:flex;flex-direction:column;gap:14px;" @submit.prevent="handleLogin">
              ...
              <Button type="submit" variant="default" full-width size="md" :loading="loading" style="margin-top:4px;">Login</Button>
            </form>

            <div style="margin:20px 0;"><Divider label="atau" /></div>

            <Button variant="outline" full-width size="md">
        ...
        <Modal v-model="showSuccess" size="sm" :closable="false" :close-on-overlay="false">
          <div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px 0 4px;text-align:center;">
            ...
            <Button variant="default" full-width size="md" style="margin-top:4px;" @click="showSuccess = false">Lanjut ke Dashboard</Button>
          </div>
        </Modal>
      </div>
    `,
      ...
      <div style="${GRID}">
        ...
        <div style="${RIGHT}">
          <div style="${FORM}">
            ...
            <form style="display:flex;flex-direction:column;gap:14px;" @submit.prevent="handleSend">
              ...
              <Button type="submit" variant="default" full-width size="md" :loading="loading">Kirim Tautan</Button>
              <Button type="button" variant="outline" full-width size="md" :disabled="countdown > 0">
        ...
        <Modal v-model="showSuccess" size="sm" :closable="false" :close-on-overlay="true">
          <div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px 0 4px;text-align:center;">
            ...
            <Button variant="default" full-width size="md" style="margin-top:4px;" @click="showSuccess = false">Oke, Mengerti</Button>
          </div>
        </Modal>
      </div>
    `,
      ...
      <div style="${GRID}">
        ...
        <div style="${RIGHT}">
          <div style="${FORM}">
            ...
            <form style="display:flex;flex-direction:column;gap:14px;" @submit.prevent="handleReset">
              ...
              <Button type="submit" variant="default" full-width size="md" :loading="loading" style="margin-top:4px;">Simpan Password</Button>
            </form>
          </div>
        </div>
        ...
        <Modal v-model="showSuccess" size="sm" :closable="false" :close-on-overlay="false">
          <div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px 0 4px;text-align:center;">
            ...
            <Button variant="default" full-width size="md" style="margin-top:4px;" @click="showSuccess = false">Masuk Sekarang</Button>
          </div>
        </Modal>
      </div>
    `,
      ...
      <div style="${GRID}">
          ...
          <div style="${FORM}">
            ...
            <template v-if="step === 'email'">
              <form style="display:flex;flex-direction:column;gap:14px;" @submit.prevent="handleEmailNext">
                ...
                <Button type="submit" variant="default" full-width size="md">Selanjutnya</Button>
              </form>
              <div style="margin:20px 0;"><Divider label="atau" /></div>
              <Button variant="outline" full-width size="md" @click="step = 'form-google'">
                <template #leading><span v-html="GoogleSVG" style="display:flex;align-items:center;" /></template>
            ...
            <template v-else-if="step === 'form-email'">
              <form style="display:flex;flex-direction:column;gap:12px;" @submit.prevent="handleRegister">
                ...
                <Button type="submit" variant="default" full-width size="md" :loading="loading" style="margin-top:2px;">Daftar Sekarang</Button>
              </form>
        ...
        <Modal v-model="showSuccess" size="sm" :closable="false" :close-on-overlay="false">
          <div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px 0 4px;text-align:center;">
            ...
            <Button variant="default" full-width size="md" style="margin-top:4px;" @click="showSuccess = false">Mulai Sekarang</Button>
          </div>
        </Modal>
      </div>
    `,
...
// ════════════════════════════════════════════════════════════════════════════════
// Story 5 — Full Auth Flow (Connected)
// ════════════════════════════════════════════════════════════════════════════════
      ...
      <div style="${GRID}">
        ...
        <div style="${RIGHT}">
          <div style="${FORM}">
            ...
            <template v-else-if="page === 'signup'">
              ...
              <div style="margin:20px 0;"><Divider label="atau" /></div>
              <Button variant="outline" full-width size="md" @click="go('signup-google')">
                <template #leading><span v-html="GoogleSVG" style="display:flex;align-items:center;" /></template>
                Daftar dengan Google
              </Button>
              <p style="text-align:center;font-size:13px;color:var(--color-text-secondary);margin-top:20px;">
        ...
        <Modal v-model="showSuccess" size="sm" :closable="false" :close-on-overlay="false">
          <div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px 0 4px;text-align:center;">
            ...
            <Button variant="default" full-width size="md" style="margin-top:4px;"
